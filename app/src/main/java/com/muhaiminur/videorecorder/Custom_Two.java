...
public class Custom_Two extends AppCompatActivity {

    @BindView(R.id.video_start)
    Button videoStart;
    @BindView(R.id.pic_description)
    TextView picDescription;
    @BindView(R.id.progressBar)
    ProgressBar progressBar;
    @BindView(R.id.compressionMsg)
    LinearLayout compressionMsg;


    public static final String LOG_TAG = Custom_Two.class.getSimpleName();

    public static final String FILE_PROVIDER_AUTHORITY = "com.muhaiminur.videorecorder.provider";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom__two);
    ...
    private File createMediaFile(int type) throws IOException {
        ...
        File storageDir = Environment.getExternalStoragePublicDirectory(
                type == TYPE_IMAGE ? Environment.DIRECTORY_PICTURES : Environment.DIRECTORY_PICTURES);
        ...
        if (requestCode == REQUEST_TAKE_CAMERA_PHOTO && resultCode == Activity.RESULT_OK) {
            ...
            if (data.getData() != null) {
                ...
                if (f.mkdirs() || f.isDirectory())
                    ...
                    Log.d("Abir1", mCurrentPhotoPath + " ok " + f.getPath());
    ...
    class VideoCompressAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... paths) {
            ...
            try {
                Log.d("Abir2", paths[0] + " ok " + paths[1]);
